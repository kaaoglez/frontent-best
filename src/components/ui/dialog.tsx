...
function DialogOverlay({
  className,
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Override> & { zIndex?: string }) {
  const { zIndex, ...rest } = props as React.ComponentProps<typeof DialogPrimitive.Override> & { zIndex?: string }
  return (
