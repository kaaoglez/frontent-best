...
import {
  ...
  AlertTriangle, Maximize, Minimize, Monitor, ArrowLeft, Heart, Subtitles, CaptionsOff, Loader2, PlayCircle, RotateCcw,
} from 'lucide-react';
...
export default function TvShowsSection() {
  ...
  } = useVideoProgress({ videoPath: currentTvVideo?.path ?? null, videoRef });
        ...
        <div ref={playerContainerRef} className="fixed inset-0 z-50 bg-black flex flex-col">
          ...
          {videoError ? (
            ...
            <div className="relative flex-1">
              <video ref={videoRef} className="w-full h-full object-contain" autoPlay={showResumePrompt ? false : true} controls playsInline onError={() => setVideoError(true)} src={getStreamUrl(currentTvVideo)} />
                ...
                <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/70 backdrop-blur-sm">
                  <div className="flex flex-col items-center gap-4 p-8 max-w-sm text-center">
                    ...
                    <div className="flex gap-3">
                      <Button onClick={resumeFromSaved} className="bg-sky-600 hover:bg-sky-700 text-white">
